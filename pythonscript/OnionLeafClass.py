...
def process_image_data(image_url):
    ...
    if new_image_values:
        edge_detection, red_value, green_value, blue_value = new_image_values
        print(f"\nNilai Edge Detection: {edge_detection}")
        print(f"Nilai Red: {red_value}")
        print(f"Nilai Green: {green_value}")
        print(f"Nilai Blue: {blue_value}")
        ...
        print("Gagal mendapatkan nilai Edge Detection, Red, Green, dan Blue.")
